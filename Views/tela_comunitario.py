...
# Form implementation generated from reading ui file 'tela_comunitario.ui'
#
...
class Tela_comunitario(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_11.setText(_translate("MainWindow", "Home / Comunitário "))
        ...
        item.setText(_translate("MainWindow", "1º DOSE"))
        item = self.tableWidget.horizontalHeaderItem(5)
        item.setText(_translate("MainWindow", "2º DOSE"))
        item = self.tableWidget.horizontalHeaderItem(6)
        item.setText(_translate("MainWindow", "DATA 1º DOSE"))
        item = self.tableWidget.horizontalHeaderItem(7)
        item.setText(_translate("MainWindow", "DATA 2º DOSE"))
        ...
        item.setText(_translate("MainWindow", "Wendel"))
        item = self.tableWidget.item(0, 2)
        item.setText(_translate("MainWindow", "1111111111"))
        item = self.tableWidget.item(0, 3)
        item.setText(_translate("MainWindow", "123456"))
        item = self.tableWidget.item(0, 4)
        item.setText(_translate("MainWindow", "SIM"))
        item = self.tableWidget.item(0, 5)
        item.setText(_translate("MainWindow", "Não"))
        item = self.tableWidget.item(0, 6)
        item.setText(_translate("MainWindow", "20/09/2021"))
        item = self.tableWidget.item(0, 7)
        item.setText(_translate("MainWindow", "20/12/2021"))
        item = self.tableWidget.item(0, 8)
        item.setText(_translate("MainWindow", "PFIZER"))
