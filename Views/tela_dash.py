...
# Form implementation generated from reading ui file 'tela_dash.ui'
#
...
class Tela_dash(object):
    def setupUi(self, MainWindow):
        ...
        self.frame_6.setGeometry(QtCore.QRect(170, 40, 191, 80))
        self.frame_6.setStyleSheet("background-color: rgb(186, 189, 182);\n"
                                   "border-radius: 5px;")
        ...
        self.frame_7.setGeometry(QtCore.QRect(80, 150, 141, 80))
        self.frame_7.setStyleSheet("background-color: rgb(186, 189, 182);\n"
                                   "border-radius: 5px;")
        self.frame_7.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_7.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_7.setObjectName("frame_7")
        self.label_12 = QtWidgets.QLabel(self.frame_7)
        self.label_12.setGeometry(QtCore.QRect(30, 10, 71, 21))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.label_12.setFont(font)
        self.label_12.setStyleSheet("color: #FFF;")
        self.label_12.setObjectName("label_12")
        self.qtd_d1 = QtWidgets.QLabel(self.frame_7)
        self.qtd_d1.setGeometry(QtCore.QRect(50, 40, 71, 21))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.qtd_d1.setFont(font)
        self.qtd_d1.setStyleSheet("color: #FFF;")
        self.qtd_d1.setObjectName("qtd_d1")
        self.frame_8 = QtWidgets.QFrame(self.frame_4)
        self.frame_8.setGeometry(QtCore.QRect(290, 150, 141, 80))
        self.frame_8.setStyleSheet("background-color: rgb(186, 189, 182);\n"
                                   "border-radius: 5px;")
        self.frame_8.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_8.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_8.setObjectName("frame_8")
        self.label_13 = QtWidgets.QLabel(self.frame_8)
        self.label_13.setGeometry(QtCore.QRect(40, 10, 70, 20))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.label_13.setFont(font)
        self.label_13.setStyleSheet("color: #FFF;")
        self.label_13.setObjectName("label_13")
        self.qtd_d2 = QtWidgets.QLabel(self.frame_8)
        self.qtd_d2.setGeometry(QtCore.QRect(40, 40, 71, 21))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.qtd_d2.setFont(font)
        self.qtd_d2.setStyleSheet("color: #FFF;")
        self.qtd_d2.setObjectName("qtd_d2")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_11.setText(_translate("MainWindow", "Total imunizados"))
        self.label_12.setText(_translate("MainWindow", "1ª DOSE"))
        self.qtd_d1.setText(_translate("MainWindow", "1"))
        self.label_13.setText(_translate("MainWindow", "2ª DOSE"))
        self.qtd_d2.setText(_translate("MainWindow", "1"))
