...
"border-radius: 5px;")
        ...
        self.lote_1.setGeometry(QtCore.QRect(70, 100, 291, 25))
        self.lote_1.setObjectName("lote_1")
        self.lote_2 = QtWidgets.QLineEdit(self.frame_6)
        self.lote_2.setGeometry(QtCore.QRect(70, 160, 291, 25))
        self.lote_2.setObjectName("lote_2")
        self.codigo_ubs = QtWidgets.QLineEdit(self.frame_6)
        self.codigo_ubs.setGeometry(QtCore.QRect(70, 190, 131, 25))
        self.codigo_ubs.setObjectName("codigo_ubs")
        self.codigo_acs = QtWidgets.QLineEdit(self.frame_6)
        self.codigo_acs.setGeometry(QtCore.QRect(210, 190, 151, 25))
        self.codigo_acs.setObjectName("codigo_acs")
...
"color: #FFF;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_11.setText(_translate("MainWindow", "Home / UBS / Adicionar Comunitário"))
        ...
        self.codigo_ubs.setText(_translate("MainWindow", "Código UBS"))
        self.codigo_ubs.setPlaceholderText(_translate("MainWindow", "Nome"))
        self.codigo_acs.setText(_translate("MainWindow", "Código ACS"))
        self.codigo_acs.setPlaceholderText(_translate("MainWindow", "Nome"))
