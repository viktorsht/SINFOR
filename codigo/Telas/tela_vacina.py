...
# Form implementation generated from reading ui file 'tela_vacina.ui'
#
...
class Tela_vacina(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_11.setText(_translate("MainWindow", "Home / Vacina "))
        ...
        item.setText(_translate("MainWindow", "REFOÇO"))
        ...
        item.setText(_translate("MainWindow", "CoronaVac"))
        item = self.tableWidget.item(0, 2)
        item.setText(_translate("MainWindow", "12"))
        item = self.tableWidget.item(0, 3)
        item.setText(_translate("MainWindow", "Butantan"))
        item = self.tableWidget.item(1, 0)
        item.setText(_translate("MainWindow", "2"))
        item = self.tableWidget.item(1, 1)
        item.setText(_translate("MainWindow", "AstraZeneca"))
        item = self.tableWidget.item(1, 2)
        item.setText(_translate("MainWindow", "90"))
        item = self.tableWidget.item(1, 3)
        item.setText(_translate("MainWindow", "Oxford/Fiocruz"))
        ...
        item.setText(_translate("MainWindow", "BioNTech"))
        item = self.tableWidget.item(3, 0)
        item.setText(_translate("MainWindow", "4"))
        item = self.tableWidget.item(3, 1)
        item.setText(_translate("MainWindow", "Sputnik V"))
        item = self.tableWidget.item(3, 2)
        item.setText(_translate("MainWindow", "90"))
        item = self.tableWidget.item(3, 3)
        item.setText(_translate("MainWindow", "Instituto Gamaleya"))
