...
# Form implementation generated from reading ui file 'tela_cadastrar_vacina.ui'
#
...
class Tela_cadastrar_vacina(object):
    def setupUi(self, MainWindow):
        ...
        self.label_11.setGeometry(QtCore.QRect(20, 20, 211, 17))
        ...
        self.nome.setGeometry(QtCore.QRect(70, 40, 291, 25))
        self.nome.setObjectName("nome")
        self.laboratorio = QtWidgets.QLineEdit(self.frame_6)
        self.laboratorio.setGeometry(QtCore.QRect(70, 100, 291, 25))
        self.laboratorio.setText("")
        self.laboratorio.setObjectName("laboratorio")
        self.reforco = QtWidgets.QLineEdit(self.frame_6)
        self.reforco.setGeometry(QtCore.QRect(70, 70, 291, 25))
        self.reforco.setObjectName("reforco")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_11.setText(_translate(
            "MainWindow", "Home / UBS / Adicionar Vacina"))
        self.nome.setPlaceholderText(_translate("MainWindow", "Nome"))
        self.laboratorio.setPlaceholderText(
            _translate("MainWindow", "Laboratório"))
        self.reforco.setPlaceholderText(_translate("MainWindow", "Reforço"))
